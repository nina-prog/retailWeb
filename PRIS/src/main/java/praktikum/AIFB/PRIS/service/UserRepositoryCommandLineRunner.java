...
public class UserRepositoryCommandLineRunner implements CommandLineRunner {
  ...
  // log id returned by creating the User in method run() (Logging: notieren der
  // Zwischenzustände eines Programmes)
  ...
  public void run(String... args) throws Exception {
    ...
    // New User is generated: User [id=1, username=Max, password=Mueller,
    // role=Admin, retail_store]
